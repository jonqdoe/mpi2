...
void calc_Unb() {
  ...
  U_chiab_gg = integrate( tmp ) * chiAB / rho0 ;

  
  // Polymer chi A-C contribution //
  fftw_fwd( rho[0] , ktmp ) ;
  ...
  U_chiac = integrate( tmp ) * chiAC / rho0 ;
  
  // Polymer chi B-C contribution //
  fftw_fwd( rho[1] , ktmp ) ;
  ...
  U_chibc = integrate( tmp ) * chiBC / rho0 ;
